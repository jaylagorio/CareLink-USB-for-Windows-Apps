...
## Next Steps
At this point there isn't anything new necessary to work with the CareLink USB stick in Windows. If another organization was to come forward and sign the INF file included in this project that would be an effective alternative to waiting for Medtronic if they're interested in doing that at all. I welcome contact from anyone willing to do this.
